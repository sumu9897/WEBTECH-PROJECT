...
<fieldset style="text-align: center; width:400px;" >
    <form name="myform"  onsubmit="validateform();" action="../../controller/admin/ForgetPassword_action.php" class="text-center" method="post">
        
        <label style="font-size: 35px;">Email : </label>
        <input style="font-size: 25px;" class="form-control" type="text" name="mail" id="mail" placeholder="Enter Your email"  onblur="checkEmail()" onkeyup="checkMail()">
        <p style="color: red;">
        <?php if ($mailError != "") {
            echo $mailError;
        } else {
            ...
            <span><a href="./admin_login.php">Log In</a></span>
        </form>
</fieldset>
