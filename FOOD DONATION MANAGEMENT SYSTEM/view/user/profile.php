    ...
    <?php include'./sideber2.php';?>
            ...
            <form action="../../controller/user/profile_action.php" method="POST" enctype="multipart/form-data">
                    ...
                    <img src="<?php if ($_SERVER['REQUEST_METHOD'] === 'GET') {
                                    ...
                                    echo "../../images/user_Images/temp.png";
                                } ?>" alt="Profile Picture" width="75px" height="75px" style="border-radius: 50%"> <br><br>
                    ...
                    <label>Gender :</label><?php echo $P_gender;?><br><br>
                    <label>Phone : </label><?php echo $P_phone;?><br><br>
                    <label>Address : </label><?php echo $P_address;?><br><br>
